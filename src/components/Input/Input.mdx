...
Input field with a help text displayed below the input. Useful for providing guidance or additional information to users.

<Canvas of={InputStories.WithHelpText} />

**Key Props:**
- `helpText="This is some helpful text to guide the user."` - Displays help text below the input field
